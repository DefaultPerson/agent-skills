# ADR format (for /blueprint Phase 5 offers)
...
## When /blueprint offers an ADR (all three must be true)
...
Cap: maximum 3 ADR offers per /blueprint run to prevent fatigue. If more than 3 candidates pass the criteria, surface the 3 with the highest reverse-cost.
