...
This step exists because cleanup files often grow too large/mixed for one `/blueprint` cycle. If splitting doesn't help downstream focus — it's pointless. Don't split for splitting's sake.
